...
class FlxSplash extends FlxState {
	...
	override public function create():Void {
		...
		_colors = [0xFF00FF00, 0xFFFFFF00, 0xFF0000, 0x0000FF, 0x00FFFF];
	...
	function timerCallback(Timer:FlxTimer):Void {
		...
		if (_curPart == 5) {
            ...
            FlxTween.tween(_sprite, {alpha: 0}, 3.0, {onComplete: onComplete});
			FlxTween.tween(_text, {alpha: 0}, 3.0);
		}
	}
